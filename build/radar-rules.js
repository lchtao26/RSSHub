({ "81.cn":{ _name:"中国军网",
  ...
  "duozhuayu.com":{ _name:"多抓鱼",
    ".":[ { title:"图书分类",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/book-categories/:categoryId",
          "/book-categories/:categoryId?subCategoryId=:subCategoryId" ],
        target:"/duozhuayu/book-categories/:categoryId/:subCategoryId?" },
      { title:"榜单",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/charts/:id" ],
        target:"/duozhuayu/charts/:id" },
      { title:"服饰搜索",
        docs:"https://docs.rsshub.app/routes/shopping",
        source:[ "/search/clothing/:keyword" ],
        target:"/duozhuayu/clothing/:keyword" },
      { title:"搜索结果",
        docs:"https://docs.rsshub.app/routes/shopping",
